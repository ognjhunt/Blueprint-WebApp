...
const videoBytes = readFileSync(new URL("./fixtures/result-audit-video.webm", import.meta.url));
const videoDigest = `sha256:${createHash("sha256").update(videoBytes).digest("hex")}`;
