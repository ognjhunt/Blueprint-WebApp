...
test("world models catalog route redirects to the Sites library", async ({
  page,
}) => {
...
test("world-model detail route redirects to the live Sites library", async ({
  page,
}) => {
...
test("legacy hosted setup does not expose a fixture site", async ({ page }) => {
  await page.goto("/world-models/sw-chi-01/start", {
