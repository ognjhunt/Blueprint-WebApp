...
function seedApprovedPayout(params: {
  ...
  state.docs.set(docKey("creatorPayouts", params.id), {
    ...
    payout_funding_policy: {
      ...
      buyer_order_id: `order-${params.id}`,
      realized_buyer_revenue_cents: params.amountCents + 1000,
    },
    ...
    payout_funding_reconciliation: {
      ...
      mode: "buyer_revenue_linked",
      buyer_order_id: `order-${params.id}`,
      approved_payout_cents: params.amountCents,
      realized_buyer_revenue_cents: params.amountCents + 1000,
      buyer_revenue_margin_cents: 1000,
