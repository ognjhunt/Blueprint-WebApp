...
router.get("/current", async (_req, res) => {
  ...
  return res.json({
    ...
    request: {
      ...
      qualification_state: record.qualification_state || record.status || null,
      opportunity_state: record.opportunity_state || null,
      rights_status: record.ops?.rights_status || null,
      capture_status: record.ops?.capture_status || null,
      quote_status: record.ops?.quote_status || null,
