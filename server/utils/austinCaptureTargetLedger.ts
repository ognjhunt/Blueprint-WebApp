...
export function renderAustinCaptureTargetLedgerMarkdown(
  ...
  return [
    ...
    "- longer-horizon discovery lanes so Austin expansion does not become random",
    "",
    "## Workflow Priorities",
    "",
    ...
    "## Operating Rules",
    "",
    "- The priority proof targets should drive real Austin capture pursuit first.",
    "- The queued lawful-access buckets should stay dormant until at least one Austin proof pack is clean and rights-cleared.",
