...
const copy: Record<TaskLifecycleMilestone, { subject: string; body: (url: string, detail: string) => string }> = {
  ...
  listing_live: {
    ...
    body: (url) => `Robot teams can now see the task card you approved. It shows only the text and image you reviewed; your contact details, footage and scene stay private. You can hide the card from your task page at any time.\n\nOpen your task:\n${url}`,
  },
  screening_cleared: {
