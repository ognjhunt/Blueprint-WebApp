...
export const websiteDevelopmentTestEnvironment = z.discriminatedUnion("kind", [
  z.object({
  ...
  z.object({
    kind: z.literal("development_drawer_fixture"),
    label: z.literal("Development drawer fixture; captured scene integration pending."),
    ...developmentTestBoundary,
  }).strict(),
]);
