...
const envSchema = z
  .object({
    ...
    DEEPSEEK_BASE_URL: z.string().trim().url().optional(),
    DEEPSEEK_TIMEOUT_MS: z.coerce.number().int().positive().optional(),
    DEEPSEEK_MAX_TOKENS: z.coerce.number().int().positive().optional(),
    DEEPSEEK_THINKING: z.string().trim().optional(),
    DEEPSEEK_REASONING_EFFORT: z.string().trim().optional(),
    DEEPSEEK_DEFAULT_MODEL: z.string().trim().optional(),
    DEEPSEEK_WAITLIST_AUTOMATION_MODEL: z.string().trim().optional(),
    DEEPSEEK_INBOUND_QUALIFICATION_MODEL: z.string().trim().optional(),
    DEEPSEEK_POST_SIGNUP_MODEL: z.string().trim().optional(),
    DEEPSEEK_OPERATOR_THREAD_MODEL: z.string().trim().optional(),
    DEEPSEEK_SUPPORT_TRIAGE_MODEL: z.string().trim().optional(),
    DEEPSEEK_PAYOUT_EXCEPTION_MODEL: z.string().trim().optional(),
    DEEPSEEK_PREVIEW_DIAGNOSIS_MODEL: z.string().trim().optional(),
    DEEPSEEK_CAPTURE_DISPATCH_MODEL: z.string().trim().optional(),
    DEEPSEEK_OUTBOUND_OUTREACH_MODEL: z.string().trim().optional(),
    DEEPSEEK_EXTERNAL_HARNESS_MODEL: z.string().trim().optional(),
    ...
    META_ADS_CLI_ENABLED: z.string().trim().optional(),
    META_ADS_CLI_BIN: z.string().trim().optional(),
    META_ADS_CLI_TIMEOUT_MS: z.coerce.number().int().positive().optional(),
    META_ADS_ACCESS_TOKEN: z.string().trim().optional(),
    META_ADS_AD_ACCOUNT_ID: z.string().trim().optional(),
    META_ADS_BUSINESS_ID: z.string().trim().optional(),
    META_ADS_MAX_DAILY_BUDGET_USD: z.coerce.number().positive().optional(),
    ...
    ANTHROPIC_BASE_URL: z.string().trim().url().optional(),
    ANTHROPIC_MODEL: z.string().trim().optional(),
    ANTHROPIC_DEFAULT_HAIKU_MODEL: z.string().trim().optional(),
    CLAUDE_CODE_SUBAGENT_MODEL: z.string().trim().optional(),
    CLAUDE_CODE_EFFORT_LEVEL: z.string().trim().optional(),
    ...
    RESEND_API_KEY_FILE: z.string().trim().optional(),
    ...
    BLUEPRINT_OPERATING_GRAPH_PROJECTION_ENABLED: z.string().trim().optional(),
    BLUEPRINT_OPERATING_GRAPH_PROJECTION_INTERVAL_MS: z.coerce.number().int().positive().optional(),
    BLUEPRINT_OPERATING_GRAPH_PROJECTION_BATCH_SIZE: z.coerce.number().int().positive().optional(),
    BLUEPRINT_OPERATING_GRAPH_PROJECTION_STARTUP_DELAY_MS: z.coerce.number().int().nonnegative().optional(),
    ...
    BLUEPRINT_GTM_HISTORICAL_CAMPAIGN_ENRICHMENT: z.string().trim().optional(),
    BLUEPRINT_GTM_INBOUND_DOSSIER_ENRICHMENT: z.string().trim().optional(),
    BLUEPRINT_GTM_CONTACT_DISCOVERY_ALLOWED_HOSTS: z.string().trim().optional(),
    BLUEPRINT_GTM_CONTACT_DISCOVERY_SEARCH_ENABLED: z.string().trim().optional(),
    BLUEPRINT_GTM_CONTACT_DISCOVERY_SEARCH_URL: z.string().trim().url().optional(),
    BLUEPRINT_GTM_CONTACT_DISCOVERY_SEARCH_ALLOWED_HOSTS: z.string().trim().optional(),
    BLUEPRINT_GTM_HUMAN_RECIPIENT_EVIDENCE_PATH: z.string().trim().optional(),
    BLUEPRINT_GTM_MANUAL_RECIPIENT_EVIDENCE_PATH: z.string().trim().optional(),
    BLUEPRINT_GTM_CLAY_EXPORT_PATH: z.string().trim().optional(),
    ...
    BLUEPRINT_LIFECYCLE_CADENCE_ENABLED: z.string().trim().optional(),
    BLUEPRINT_LIFECYCLE_CADENCE_INTERVAL_MS: z.coerce.number().int().positive().optional(),
    BLUEPRINT_LIFECYCLE_CADENCE_BATCH_SIZE: z.coerce.number().int().positive().optional(),
    BLUEPRINT_LIFECYCLE_CADENCE_STARTUP_DELAY_MS: z.coerce.number().int().nonnegative().optional(),
    ...
    OPENAI_CAPTURE_DISPATCH_MODEL: z.string().trim().optional(),
    OPENAI_OUTBOUND_OUTREACH_MODEL: z.string().trim().optional(),
