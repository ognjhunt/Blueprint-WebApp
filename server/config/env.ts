...
const envSchema = z
  .object({
    ...
    NITROSEND_API_KEY: z.string().trim().optional(),
    NITROSEND_BASE_URL: z.string().trim().url().optional(),
    NITROSEND_WEBHOOK_SECRET: z.string().trim().optional(),
    ...
    BLUEPRINT_AUTONOMOUS_NITROSEND_AUDIENCE_ID: z.string().trim().optional(),
