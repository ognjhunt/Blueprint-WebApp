...
(async () => {
  ...
  const legacyPublicRedirects: Array<{
    ...
    { from: "/world-models", to: "/proof" },
    { from: "/world-models/:slug", to: "/proof" },
    { from: "/agents", to: "/contact?persona=robot-team&source=server-redirect" },
    { from: "/capture", to: "/capture-app/launch-access?role=capturer&source=server-redirect" },
    { from: "/sample-deliverables", to: "/proof" },
    { from: "/launch-map", to: "/contact?persona=robot-team&source=server-redirect" },
    { from: "/faq", to: "/proof" },
    { from: "/governance", to: "/proof" },
    { from: "/about", to: "/" },
    { from: "/updates", to: "/" },
    { from: "/careers", to: "/contact?persona=robot-team&source=server-redirect" },
    { from: "/help", to: "/contact?persona=robot-team&source=server-redirect" },
    { from: "/help/contact", to: "/contact?persona=robot-team&source=server-redirect" },
    { from: "/help/category/:categorySlug", to: "/contact?persona=robot-team&source=server-redirect" },
    { from: "/help/article/:articleSlug", to: "/contact?persona=robot-team&source=server-redirect" },
    ...
    { from: "/site-worlds", to: "/proof" },
    { from: "/site-worlds/:slug", to: "/proof" },
