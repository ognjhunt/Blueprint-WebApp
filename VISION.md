...
> Repo role in this vision: **`Blueprint-WebApp`** is the buyer, licensing, ops, and hosted-access
> surface — where rungs 1–2 become a product the market **transacts through**. The neutral
> standard and the deployment-decision layer are expressed here; neutrality governance lives here.
