...
source_urls:
  - "https://www.lovettindustrial.com/"
  - "https://www.lovettindustrial.com/properties/durham-logistics-center"
  - "https://www.colliers.com/en/experts/andrew-young"
  - "https://summitde.com/"
  - "https://www.botbuilt.com/"
  - "https://roiindustries.com/"
  - "https://www.welcomeventurepark.com/"
last_verified_at: "2026-04-22"
owner: demand-intel-agent
sensitivity: internal
confidence: 0.82
subject_key: durham-robot-team-target-accounts
...
canonical_refs:
  ...
  - system: report
    ref: "knowledge/reports/demand-intel/2026-04-22-durham-robot-company-target-accounts-and-buyer-clusters.md"
entity_tags:
  - robot-team-demand
  - durham
  - target-accounts
...
# Durham Robot Team Target Accounts and Buyer Clusters

## Summary

Durham is a narrow proof-led robot-team market. The strongest target accounts are tied to a subscale logistics-bay proof motion, an AMR pre-deployment evaluation workflow, and a buyer lane that stays research-only until recipient-backed contacts are verified.

Blueprint should not lead with generic robotics outreach or broad city awareness. It should lead with one bounded site, one workflow, and one proof path:

1. site lane: class-A logistics and industrial interiors
2. workflow lane: AMR pre-deployment evaluation
3. buyer proof path: exact_site
...
- The Durham target ledger names Durham Logistics Center as the first priority proof target and treats it as a subscale empty-bay candidate rather than a full-facility proof asset.
- The Durham target ledger lists a leasing-route candidate for the same Durham Logistics Center scope.
- The Durham target ledger lists Welcome Venture Park as an adjacent logistics candidate only.
- The Durham research identifies Summit Design and Engineering Services as the preferred Triangle AEC supply lane.
- The Durham research identifies BotBuilt as a local robotics buyer candidate.
- The Durham research identifies ROI Industries as a buyer candidate, but the public `info@` routing is not sufficient by itself to establish a launch-ready direct lane.
- The Durham research explicitly says buyer direct outreach stays blocked until recipient-backed contacts and artifact-fit requirements are verified.
...
- These are the highest-priority lawful-access paths.
