...
- Chicago capture target ledger with immediate top 25, next 100, and long-universe buckets.
...
- Maintain the Chicago capture target ledger: city-demand-agent owns execution, Growth Lead is the human lane, and the task closes only when The Chicago target ledger names the immediate top 25, the next 100 expansion buckets, and the long 300-1000 site universe model..
...
- Build the Chicago capturer prospect list and post package: capturer-growth-agent owns execution, Growth Lead is the human lane, and the task closes only when 25-50 curated Chicago prospects are named with source bucket, rationale, and next move, or the org explicitly switches to the broader 100-signup path..
...
- Assemble Chicago proof packs and publish 1-2 proof-ready listings: buyer-solutions-agent owns execution, Ops Lead is the human lane, and the task closes only when At least 1-2 Chicago proof-ready listings or equivalent proof packs exist with exact-site versus adjacent-site labeling..
- Research Chicago robot-company target accounts and buyer clusters: demand-intel-agent owns execution, Growth Lead is the human lane, and the task closes only when 20-40 named Chicago-relevant robot-company targets are researched with facility/workflow fit and proof-path notes..
...
- Run Chicago outbound and move serious buyers into hosted review: outbound-sales-agent owns execution, Growth Lead is the human lane, and the task closes only when 5-8 Chicago buyer conversations are active with explicit next steps..
...
| Loop | Metric | Target |
| --- | --- | --- |
| Supply | Curated Chicago supply prospects contacted | 25-50 |
| Supply | Raw Chicago supply signups if broader funnel is used | 100 |
| Supply | Approved Chicago capturers | 10-20 |
| Supply | First captures completed | 5-10 |
| Supply | QA-passed captures | 3-5 |
| Supply | Chicago proof-ready listings / proof packs | 1-2 |
