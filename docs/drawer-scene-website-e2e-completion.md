...
| Last proven control-plane release | `663a8a6ce1bd2b7dfe2fb7a9c80276fba5274560`, canonical deploy and live exact `commit_proven: true` with no blockers at 17:10 UTC. A later descendant operator-door deploy is in progress. |
