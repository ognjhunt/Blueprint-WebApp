...
- Any spend request beyond the written Austin low budget policy is out of policy until the repo policy changes.
...
- Autonomous spend posture for Austin: Low Budget with a total envelope up to $2,500.
