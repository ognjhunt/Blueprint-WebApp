# Notion Layout Checklist Template

Use this template for human or Notion Manager review of Blueprint-managed Notion pages. This is a review template only; repo docs and Paperclip remain the execution and doctrine sources of truth.
