...
| Paperclip VPS / tunnel | unknown live billing | `$30.00` | n/a | DigitalOcean / Cloudflare / Paperclip host | `ops/paperclip/README.md` | estimate | Keep one Paperclip host; no bootstrap/reconcile/restart without approval. |
