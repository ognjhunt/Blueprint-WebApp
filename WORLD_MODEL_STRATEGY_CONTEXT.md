...
- `Blueprint-WebApp` can lead with real-site robot evaluation and post-training data package requests for pre-pilot and post-evaluation buyer decisions
- those requests must stay grounded in capture-backed site packages, provenance, rights/privacy boundaries, robot profile, task scope, data scope, and threshold evidence
