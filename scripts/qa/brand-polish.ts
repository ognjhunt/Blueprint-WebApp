...
const canonicalPublicQaRoutes: PublicQaRoute[] = [
  { label: "How it works", path: "/how-it-works", canonicalPath: "/how-it-works", expectedHeading: "the robot that fits your task", requiredCtas: [{ label: "Start a task assessment", hrefStartsWith: "/contact/site-operator" }, { label: "Apply for early access", hrefStartsWith: "/contact/robot-team" }] },
  { label: "Pricing", path: "/pricing", canonicalPath: "/pricing", expectedHeading: "Robot teams pay $99 an entry.", requiredCtas: [{ label: "Start a task assessment", hrefStartsWith: "/contact/site-operator" }, { label: "Apply for early access", hrefStartsWith: "/contact/robot-team" }] },
  { label: "Home", path: "/", canonicalPath: "/", minVisibleTextLength: 300, expectedHeading: "A pilot worth running.", requiredCtas: [{ label: "Start a task assessment", hrefStartsWith: "/contact/site-operator" }, { label: "Apply for early access", hrefStartsWith: "/contact/robot-team" }] },
  { label: "Site inquiry", path: "/contact/site-operator", canonicalPath: "/contact/site-operator", expectedHeading: "Let’s start with your site.", requiredCtas: [{ label: "Building robots? Apply for early access", hrefStartsWith: "/contact/robot-team" }] },
