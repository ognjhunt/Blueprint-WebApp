...
const canonicalPublicQaRoutes: PublicQaRoute[] = [
  ...
  { label: "Pricing", path: "/pricing", canonicalPath: "/pricing", expectedHeading: "One task. Clear costs.", requiredCtas: [{ label: "Start a task assessment", hrefStartsWith: "/contact/site-operator" }, { label: "Apply for early access", hrefStartsWith: "/contact/robot-team" }] },
