...
const canonicalPublicQaRoutes: PublicQaRoute[] = [
  { label: "How it works", path: "/how-it-works", canonicalPath: "/how-it-works", expectedHeading: "Find the right fit.", requiredCtas: [{ label: "Start a task assessment", hrefStartsWith: "/contact/site-operator" }, { label: "Apply as a robot team", hrefStartsWith: "/contact/robot-team" }] },
  { label: "Pricing", path: "/pricing", canonicalPath: "/pricing", expectedHeading: "Robot teams pay to be screened.", requiredCtas: [{ label: "Start a task assessment", hrefStartsWith: "/contact/site-operator" }, { label: "Apply as a robot team", hrefStartsWith: "/contact/robot-team" }] },
  { label: "Home", path: "/", canonicalPath: "/", minVisibleTextLength: 300, expectedHeading: "A pilot worth running.", requiredCtas: [{ label: "Start a task assessment", hrefStartsWith: "/contact/site-operator" }, { label: "Apply as a robot team", hrefStartsWith: "/contact/robot-team" }] },
