...
const canonicalPublicQaRoutes: PublicQaRoute[] = [
  { label: "How it works", path: "/how-it-works", canonicalPath: "/how-it-works", expectedHeading: "From one task to a measured pilot.", requiredCtas: [{ label: "Start a task assessment", hrefStartsWith: "/contact/site-operator" }, { label: "Apply for early access", hrefStartsWith: "/contact/robot-team" }] },
  { label: "Pricing", path: "/pricing", canonicalPath: "/pricing", expectedHeading: "Agree on pilot costs before you commit.", requiredCtas: [{ label: "Start a task assessment", hrefStartsWith: "/contact/site-operator" }, { label: "Apply for early access", hrefStartsWith: "/contact/robot-team" }] },
  { label: "Home", path: "/", canonicalPath: "/", minVisibleTextLength: 300, expectedHeading: "A measured robot pilot.", requiredCtas: [{ label: "Start a task assessment", hrefStartsWith: "/contact/site-operator" }, { label: "Apply for early access", hrefStartsWith: "/contact/robot-team" }] },
  { label: "Site inquiry", path: "/contact/site-operator", canonicalPath: "/contact/site-operator", expectedHeading: "Start with one recurring task.", requiredCtas: [{ label: "Building robots? Apply for early access", hrefStartsWith: "/contact/robot-team" }] },
  { label: "Robot team task library", path: "/contact/robot-team", canonicalPath: "/contact/robot-team", expectedHeading: "Find a task your robot can support.", requiredCtas: [{ label: "Operate a site? Start here", hrefStartsWith: "/contact/site-operator" }] },
