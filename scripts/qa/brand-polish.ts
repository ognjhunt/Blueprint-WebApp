...
const canonicalPublicQaRoutes: PublicQaRoute[] = [
  ...
  { label: "Pricing", path: "/pricing", canonicalPath: "/pricing", expectedHeading: "Robot teams pay to be screened.", requiredCtas: [{ label: "Discuss your site", hrefStartsWith: "/contact/site-operator" }, { label: "Apply as a robot team", hrefStartsWith: "/contact/robot-team" }] },
