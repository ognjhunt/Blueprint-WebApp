...
const canonicalPublicQaRoutes: PublicQaRoute[] = [
  ...
  { label: "Pricing", path: "/pricing", canonicalPath: "/pricing", expectedHeading: "Robot teams pay $99 an entry.", requiredCtas: [{ label: "Start a task assessment", hrefStartsWith: "/contact/site-operator" }, { label: "Apply as a robot team", hrefStartsWith: "/contact/robot-team" }] },
