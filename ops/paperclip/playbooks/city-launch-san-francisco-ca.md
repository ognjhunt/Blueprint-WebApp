...
## Launch Thesis
San Francisco should launch only as a bounded, proof-led city program: create rights-cleared proof assets and use those exact-site artifacts to open buyer review before any volume motion.

## What Changed This Pass
- evidence-backed: the generic city-launch activation harness generated the San Francisco system doc, execution issue bundle, target ledger, and compact city playbooks in one run.
