...
- human owner: growth-lead
- purpose: Keep Austin sourcing narrow, truthful, and off the founder lane for routine approvals while explicitly distinguishing private controlled interiors from public, non-controlled commercial capture.
...
- human gate: Escalate only for rights/privacy exceptions or posture-changing source-policy changes beyond the approved Austin launch posture.
