...
## Current blockers
- san-jose-ca-send-warehouse-direct-1: missing real recipient email First proof-led direct outreach draft ready for approval.
- san-jose-ca-send-buyer-linked-1: missing real recipient email Use only when the message stays within exact-site proof posture.
