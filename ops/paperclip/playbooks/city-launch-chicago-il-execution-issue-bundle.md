...
- done when:
  - The Chicago target ledger names the immediate top 25, the next 100 expansion buckets, and the long 300-1000 site universe model.
...
- done when:
  - 25-50 curated Chicago prospects are named with source bucket, rationale, and next move, or the org explicitly switches to the broader 100-signup path.
...
- done when:
  - At least 1-2 Chicago proof-ready listings or equivalent proof packs exist with exact-site versus adjacent-site labeling.
...
- done when:
  - 20-40 named Chicago-relevant robot-company targets are researched with facility/workflow fit and proof-path notes.
...
- done when:
  - 5-8 Chicago buyer conversations are active with explicit next steps.
