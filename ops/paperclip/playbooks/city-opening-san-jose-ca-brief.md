# San Jose, CA City-Opening Brief
...
## City Opening Goal
Open San Jose with truthful awareness before expecting replies: make the right people aware that Blueprint is launching a bounded city motion, what spaces are in scope, what is out of scope, and what exact CTA path they should use.
...
## Core Message
- Who Blueprint is: a capture-first, real-site-task-first company turning real site-tasks into maintained testbeds and bounded decisions through one Task Evaluation Run.
- What is launching in San Jose: one narrow city-opening motion around exact-site hosted review, not a broad public city-launch claim.
...
- Example research-backed capture targets: Bay Area Capture Ops.
- Example buyer-side targets already named in research: Locus Robotics, Applied Intuition.
