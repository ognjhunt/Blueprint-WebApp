# Durham, NC City-Opening CTA Routing

- status: generated draft artifact
- purpose: canonical response-routing contract for city-opening replies

## CTA Standard
Every Durham city-opening asset should route replies into one tagged intake path instead of ad hoc inboxes, side notes, or disconnected DMs.
