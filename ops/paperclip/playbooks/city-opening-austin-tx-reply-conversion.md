# Austin, TX City-Opening Reply Conversion
...
## Conversion Rule
A Austin city-opening response is not converted just because it exists. It is converted when it has an owner, a next step, a follow-up due state, and a downstream routing decision.