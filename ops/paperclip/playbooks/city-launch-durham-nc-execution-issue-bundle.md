...
## Lock the first Durham subscale site scope

- key: lock-subscale-site-scope
- phase: founder_gates
- agent owner: city-launch-agent
- human owner: growth-lead
- purpose: Reduce the first Durham target from full-facility rhetoric to one empty or pre-tenant logistics bay with explicit physical scope.
- policy_guardrail: Human review lane: Growth Lead.
- dependencies: none
- metrics dependencies: first_lawful_access_path
- validation required: true
...
## Move export-control and rights screening before field dispatch

- key: pre-dispatch-rights-screen
- phase: founder_gates
- agent owner: rights-provenance-agent
- human owner: designated-human-rights-reviewer
- purpose: Confirm site authorization, defense/export-control posture, and privacy boundaries before any Durham capturer is dispatched.
- policy_guardrail: Human review lane: Designated human rights reviewer.
- dependencies: lock-subscale-site-scope
- metrics dependencies: first_lawful_access_path
- validation required: true
- source: activation_payload
- inputs:
...
## Line up Durham AEC capturer supply

- key: seed-aec-capturer-cohort
- phase: supply
- agent owner: capturer-growth-agent
- human owner: ops-lead
- purpose: Use Triangle AEC-capable supply lanes to identify the first small professional cohort for Durham capture.
- policy_guardrail: Human review lane: Ops Lead.
- dependencies: pre-dispatch-rights-screen
- metrics dependencies: first_approved_capturer
- validation required: true
- source: activation_payload
- inputs:
...
## Keep the Durham buyer lane research-only until contacts are real

- key: keep-buyer-lane-research-only
- phase: demand
- agent owner: city-demand-agent
- human owner: growth-lead
- purpose: Carry BotBuilt and ROI Industries as research-backed buyer candidates while blocking live buyer sends until recipient-backed contact evidence exists.
- policy_guardrail: Human review lane: Growth Lead.
- dependencies: none
- metrics dependencies: proof_path_assigned
- validation required: true
...
## Verify Durham buyer artifact and hosted-review fit

- key: verify-buyer-artifact-fit
- phase: commercial
- agent owner: buyer-solutions-agent
- human owner: ops-lead
- purpose: Validate mesh, point-cloud, and hosted-review expectations for Durham robotics buyers before claiming stack fit.
- policy_guardrail: Human review lane: Ops Lead.
- dependencies: keep-buyer-lane-research-only
- metrics dependencies: proof_pack_delivered, hosted_review_ready
- validation required: true
- source: activation_payload
- inputs:
  - city-launch activation payload
...
## Keep the Durham scorecard honest

- key: keep-durham-scorecard-honest
- phase: measurement
- agent owner: analytics-agent
- human owner: ops-lead
- purpose: Track Durham only with approved proof-motion events and milestones, and surface blocked buyer-contact and lawful-access gaps directly.
- policy_guardrail: Human review lane: Ops Lead.
- dependencies: none
- metrics dependencies: robot_team_inbound_captured, proof_path_assigned, proof_pack_delivered, hosted_review_ready, hosted_review_started, hosted_review_follow_up_sent, human_commercial_handoff_started, proof_motion_stalled
- validation required: false
