# Chicago, IL City-Opening Execution Report
...
## Current blockers
- chicago-il-send-warehouse-direct-1: missing real recipient email First proof-led direct outreach draft ready for approval.
- chicago-il-send-buyer-linked-1: missing real recipient email Use only when the message stays within exact-site proof posture.
- chicago-il-send-professional-capturer-1: missing real recipient email First curated professional outreach draft ready for approval.