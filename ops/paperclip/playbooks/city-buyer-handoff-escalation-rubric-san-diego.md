# Blueprint City Buyer Handoff And Escalation Rubric - San Diego

## Scope
This playbook defines how San Diego-sourced proof review becomes standard commercial handling.
...
## San Diego Posture
San Diego should be treated as a gated-cohort proof-and-commercialization market. Do not pull manual review into routine pricing or proof follow-up.

### Keep San Diego In Normal Buyer Follow-Up When
...
### Route San Diego To `ops-lead` When
...
### Route San Diego To Standard Commercial Handling When
...
- frame quotes against the published anchors and flag exceptions early rather than inventing new package names
...
### Route San Diego To Operator / Access Review When
...
## Current Limitation
San Diego proof-review conversion data is still sparse. This rubric is evidence-backed on channel structure and shared handoff rules, but the exact trigger thresholds should tighten as city-tagged funnel data becomes real.
