# San Jose, CA — Blueprint City Launch Plan
...
- evidence-backed: the target ledger mode for this city is `deep_research_records`. Research-backed named targets already available include Edenvale Industrial Park corridor, 550 Piercy Road, 6480 Hellyer Avenue.
- warning: Activation-ready capturer direct-outreach lanes for San Jose, CA have named targets but no explicit contact_email evidence.
...
- San Jose should open with two explicit awareness tracks: warehouse/facility direct awareness to named buyers, operators, and integrators; and bounded public-commercial awareness through many small community placements rather than one broad campaign.
...
- San Jose city-opening brief with warehouse/facility and public-commercial awareness split
- San Jose city channel map naming channels, audiences, owners, and message posture
- San Jose first-wave outreach/posting pack with direct outreach variants and bounded community-placement variants
- San Jose CTA / intake path with source tags and next-owner routing
- San Jose response-tracking view showing which channels produced real replies
- San Jose reply-conversion queue and follow-up cadence rules so live responses move into the correct next lane
...
- high: Verify stack compatibility before public claim or live outreach. (validation required)
- high: Verify air-gapped or export-controlled review needs before outreach to defense-adjacent buyers. (validation required)
...
Do not treat San Jose as operationally real until a small number of rights-cleared sites, proof packs, and hosted reviews are real. The city should widen only after those proofs exist and the operator lanes can support them.