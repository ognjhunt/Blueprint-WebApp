# San Jose, CA City-Opening First-Wave Pack
...
- target 1: Applied Intuition — use a proof-led intro anchored to one workflow lane and one truthful CTA.
- target 2: AutoX — use a proof-led intro anchored to one workflow lane and one truthful CTA.
- target 3: Brain Corp — use a proof-led intro anchored to one workflow lane and one truthful CTA.
- target site anchors currently available: Edenvale Industrial Park corridor, 550 Piercy Road, 6480 Hellyer Avenue.
