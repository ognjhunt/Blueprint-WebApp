...
- planning-state: in progress

## Launch Thesis
San Jose should launch only as a bounded, proof-led city program: create rights-cleared proof assets and use those exact-site artifacts to open buyer review before any volume motion.
