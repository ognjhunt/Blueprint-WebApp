...
- purpose: Rank the first San Jose proof candidates and discovery lanes against the exact-site hosted-review wedge.
...
- human owner: growth-lead
- purpose: Keep San Jose sourcing narrow, truthful, and off the founder lane for routine approvals while explicitly distinguishing private controlled interiors from public, non-controlled commercial capture.
...
- human owner: growth-lead
- purpose: Define who needs to hear about the San Jose motion and which channels are in scope.
...
- purpose: Route San Jose replies into the live intake path instead of ad hoc side conversations.
- human gate: none
- dependencies: city-opening-distribution
- metrics dependencies: none
- validation required: false
- source: activation_payload
- inputs:
...
- human owner: growth-lead
- purpose: Turn the city-opening brief into concrete first-wave assets that can create the first responses.
...
- agent owner: city-launch-agent
- human owner: growth-lead
- purpose: Prepare the operator-side access path for San Jose warehouses and facilities.
...
- dependencies: city-opening-distribution, city-target-ledger
- metrics dependencies: first_lawful_access_path
- validation required: false
- source: activation_payload
- inputs:
...
- done when:
  - The first operator-outreach draft or intro packet is ready for human review.
...
- agent owner: ops-lead
- human owner: ops-lead
- purpose: Give Intake, Field Ops, QA, and Rights lanes explicit San Jose rules.
- human gate: none
...
- agent owner: capturer-growth-agent
- human owner: growth-lead
- purpose: Generate the first San Jose professional supply wave and keep it rights-safe.
...
- dependencies: city-target-ledger, city-opening-first-wave-pack, city-opening-cta-routing
- metrics dependencies: none
- validation required: false
- source: activation_payload
- inputs:
...
- agent owner: capturer-growth-agent
- human owner: growth-lead
- purpose: Open a bounded online-community sourcing lane for public, non-controlled commercial locations.
- human gate: none
- dependencies: city-opening-first-wave-pack, city-opening-cta-routing
- metrics dependencies: none
- validation required: false
- source: activation_payload
- inputs:
