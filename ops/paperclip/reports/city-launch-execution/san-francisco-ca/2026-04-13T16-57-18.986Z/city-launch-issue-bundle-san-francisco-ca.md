...
- done when:
  - The San Francisco target ledger names the first proof candidates, queued lawful-access buckets, and longer-horizon discovery lanes.
...
- done when:
  - A curated first-wave San Francisco prospect set is named with source bucket, rationale, lawful access posture, and next move.
...
- done when:
  - At least one San Francisco proof-ready listing or equivalent proof pack exists with exact-site versus adjacent-site labeling.
...
- done when:
  - A named San Francisco buyer target set is researched with facility/workflow fit and proof-path notes.
...
- done when:
  - San Francisco buyer conversations are active with explicit next steps.
