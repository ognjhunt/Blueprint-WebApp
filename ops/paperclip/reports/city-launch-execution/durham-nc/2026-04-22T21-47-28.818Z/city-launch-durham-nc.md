# Durham, NC — Blueprint City Launch Plan
...
- planning-state: refresh in progress
...
- warning: Activation-ready buyer direct-outreach lanes for Durham, NC have named targets but no explicit contact_email evidence.
...
- Durham should open with two explicit awareness tracks: warehouse/facility direct awareness to named buyers, operators, and integrators; and bounded public-commercial awareness through many small community placements rather than one broad campaign.
...
- Durham live post/outreach send ledger with ready-to-send, sent, or blocked state plus first-send approval
- Durham city-opening execution report showing what actually went live versus what is still pending
...
Do not treat Durham as operationally real until a small number of rights-cleared sites, proof packs, and hosted reviews are real. The city should widen only after those proofs exist and the operator lanes can support them.