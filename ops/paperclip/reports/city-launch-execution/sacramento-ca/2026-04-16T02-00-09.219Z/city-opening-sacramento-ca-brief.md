# Sacramento, CA City-Opening Brief
...
## City Opening Goal
Open Sacramento with truthful awareness before expecting replies: make the right people aware that Blueprint is launching a bounded city motion, what spaces are in scope, what is out of scope, and what exact CTA path they should use.
...
- What is launching in Sacramento: one narrow city-opening motion around exact-site hosted review, not a broad public city-launch claim.
...
- Example research-backed capture targets: US Cold Storage - Ambient Module, McClellan Park - Building 775 (Light Industrial), Sacramento Costco - Natomas.
- Example buyer-side targets already named in research: Raymond West, Lineage Logistics, Locus Robotics.
