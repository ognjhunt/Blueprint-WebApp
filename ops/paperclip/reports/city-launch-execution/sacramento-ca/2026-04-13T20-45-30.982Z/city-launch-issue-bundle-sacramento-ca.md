...
- human owner: growth-lead
- purpose: Generate the first Sacramento supply wave and push the first real prospect or invite response into the live intake path without widening private controlled interiors into generic gig-market posture.
...
- done when:
  ...
  - Public, non-controlled commercial capture is allowed to use bounded online community sourcing, while private controlled interiors stay on stricter channels.
