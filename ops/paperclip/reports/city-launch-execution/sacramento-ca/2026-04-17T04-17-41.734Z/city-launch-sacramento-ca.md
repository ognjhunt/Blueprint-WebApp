...
- evidence-backed: the target ledger mode for this city is `deep_research_records`. Research-backed named targets already available include US Cold Storage - Ambient Module, McClellan Park - Building 775 (Light Industrial), Sacramento Costco - Natomas.
