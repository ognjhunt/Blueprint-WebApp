...
3. Make city-opening distribution explicit through a city-opening brief, channel map, first-wave outreach/posting pack, exact CTA/intake routing, and response tracking so the city does not wait for replies from people who were never reached.
...
- city-launch-agent, capturer-growth-agent, ops-lead, and analytics-agent make Sacramento city-opening distribution explicit through a city-opening brief, channel map, first-wave outreach/posting pack, city-facing CTA path, and response-tracking view before the system assumes the city has heard about Blueprint.
...
- Sacramento city-opening brief, channel map, first-wave outreach/posting pack, CTA / intake path, and response-tracking view are required to prove the city was actually opened before the org waits on replies.
