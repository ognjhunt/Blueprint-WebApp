...
- human owner: growth-lead
- purpose: Generate the first Sacramento supply wave without widening into generic gig-market posture.
...
- human owner: ops-lead
- purpose: Classify Sacramento applicants using the approved rubric instead of ad hoc founder review.
