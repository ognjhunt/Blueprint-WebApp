...
- dependencies: austin-target-ledger, growth-source-policy
- inputs:
  - capturer-supply-playbook.md
  - city-launch-austin-tx.md
...
## Assign first captures, reminders, and site-facing trust prep
...
- dependencies: austin-target-ledger, rights-clearance
- inputs:
