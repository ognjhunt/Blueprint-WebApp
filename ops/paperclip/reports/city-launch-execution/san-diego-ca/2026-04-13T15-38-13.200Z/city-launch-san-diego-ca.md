# San Diego, CA — Blueprint City Launch Plan
...
## Launch Thesis
San Diego should launch only as a bounded, proof-led city program: secure site-operator authorization first, create a few rights-cleared proof assets, and use those exact-site artifacts to open buyer review before any volume motion.

## What Changed This Pass
- evidence-backed: the generic city-launch activation harness generated the San Diego system doc, execution issue bundle, target ledger, and compact city playbooks in one run.
...
- evidence-backed: the target ledger mode for this city is `deep_research_records`. Research-backed named targets already available include Otay Business Park Logistics Center, Sorrento Valley Biotech Facility.
...
- Phase 0 is site acquisition: secure operator-approved, rights-cleared access before dispatching capturers into private indoor facilities.
