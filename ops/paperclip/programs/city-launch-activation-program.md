...
- activation payload surface coverage must be explicit: every launch surface must have an owner lane, human lane, artifact, evidence standard, completion gate, delegation task key, and blocker behavior before the org treats the plan as fully delegate-ready
