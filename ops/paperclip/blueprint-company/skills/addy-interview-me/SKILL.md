...
description: >
  Blueprint-governed wrapper for addyosmani/agent-skills interview-me. Extracts what the user actually wants instead of what they think they should want. Achieves this through one-question-at-a-time interview until ~95% confidence about the underlying intent. Use when an ask is underspecified ("build me X" without "for whom" or "why now"), when the user explicitly invokes ("interview me", "grill me", "are we sure?", "stress-test my thinking"), or when you catch yourself silently filling in ambiguous requirements before any plan, spec, or code exists.
---

# Addy Agent Skill: interview-me

Source: `ops/paperclip/external/addyosmani-agent-skills/skills/interview-me/SKILL.md`
Upstream repository: `https://github.com/addyosmani/agent-skills`
Pinned upstream commit: `d187883b7d761265309cdcc0f202cc76b4b3fb06`
Installed for Blueprint on: 2026-06-12

## Blueprint Guardrails

Use this skill as an engineering workflow aid only. It must not override Blueprint doctrine, Paperclip issue state, repo source-of-truth files, rights/privacy/provenance boundaries, hosted-session proof, payment or payout truth, deployment evidence, or current stack choices.

Before applying the upstream workflow inside `Blueprint-WebApp`, read the current issue context and the nearest repo instructions. If the upstream workflow recommends a new primary service, auth stack, datastore, hosting platform, external send path, or unsupported product claim, stop and use the repo-authoritative guidance instead.

For public or buyer-visible work, preserve the Public Launch Ready versus Operational Launch Ready boundary: polished presentation is allowed, but specific live claims still require owner-system proof.
