...
## Block Conditions
- the behavior has not merged or cannot be verified in repo/runtime truth
- the affected doc, section, or owner cannot be identified
- the request is marketing copy, speculative roadmap, or strategy rather than documentation accuracy

## Escalation Conditions
- Tier 1 docs are stale after a capture/API/onboarding change
- multiple agents or users rely on outdated documentation
- cross-repo contract changes lack matching docs across downstream consumers
