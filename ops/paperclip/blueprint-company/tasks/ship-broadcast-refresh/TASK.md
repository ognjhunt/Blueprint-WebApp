...
- include the `ops/paperclip/blueprint-company/skills/site-world-creative-production/SKILL.md` packet for storyboarded visuals, first/last frames, multi-reference packs, or video prompt handoffs
