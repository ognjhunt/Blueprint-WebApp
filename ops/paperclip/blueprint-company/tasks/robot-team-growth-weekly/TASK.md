...
- ingest new demand-intel findings plus any analytics, intake, ops, or finance feedback
- update Blueprint's generic robot-team demand playbook
- create downstream issues for `conversion-agent`, `analytics-agent`, `intake-agent`, `ops-lead`, `finance-support-agent`, and `city-demand-agent` where needed
