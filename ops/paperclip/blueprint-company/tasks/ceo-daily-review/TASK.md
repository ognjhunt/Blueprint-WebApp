...
When the bearer-auth plugin routes return `Board access required`, use the loopback helper with `X-Paperclip-Run-Id` and treat that response as the authoritative automation feed.
