...
function buildPackages(config: PackageConfig): [SiteWorldPackage, SiteWorldPackage] {
  return [
    ...
    },
    {
      ...
      summary:
        "Request a Blueprint-managed evaluation set for this exact site when your team wants one policy/profile run across the site task suite after setup verifies account, package, and runtime availability.",
      ...
      deliverables: [
        ...
        "Exports and policy comparison on the same site",
      ],
    },
  ];
}
...
const rawSiteWorldCards: RawSiteWorldCard[] = [
  {
    ...
    packages: buildPackages({
      ...
      siteAddress: "1847 W Fulton St, Chicago, IL 60612",
      scenePrice: "$2,400",
      hostedRate: "$6,500 / site evaluation",
      sampleTask: "Walk to shelf staging and pick the blue tote",
      sampleRobot: "Unitree G1 with head cam and wrist cam",
    }),
  },
