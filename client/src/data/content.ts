...
export const scenes: Scene[] = [
  {
    ...
    highlights: [
      "Seed3D base mesh finished for watertight topology",
...
export const caseStudies: CaseStudy[] = [
  {
    ...
    body:
      "We delivered a six-scene kitchen bundle with validated revolute and prismatic joints across ovens, reach-ins, and prep storage. The lab used Isaac Sim to author open/slide policies and transfer to in-situ hardware within two sprints.",
    outcomes: [
  ...
  },
  {
    ...
    body:
      "A robotics integrator used our warehouse lane pack to evaluate pallet-to-tote flows. We tuned colliders for suction grippers, delivered Replicator annotations, and validated in Isaac Sim 4.2 before deployment.",
    outcomes: [
  ...
  },
  {
    ...
    body:
      "We rebuilt a flagship retail aisle with signage, price tags, and semantic IDs. Teams trained grasp-place behaviors, tuned suction compliance, and exported Replicator-ready annotations.",
    outcomes: [
      "8x shelf variations",
...
export const jobs: Job[] = [
  {
    ...
    description:
      "You will translate Seed3D outputs and kitbashed assets into polished USD-ready geometry. Expect to iterate with our robotics specialists on articulation coverage, pivots, and collider tuning.",
    applyEmail: "apply+artist@tryblueprint.io",
  },
  {
    title: "Technical Artist (Isaac)",
    type: "Contract",
    location: "Remote",
    summary:
      "Author USD stages, tune joints, and validate physics so labs can drop scenes straight into Isaac Sim.",
    description:
      "Work across Blender, Omniverse, and our internal tooling to ensure every scene ships with precise limits, semantic schemas, and test harnesses. Bonus points for experience scripting Replicator.",
