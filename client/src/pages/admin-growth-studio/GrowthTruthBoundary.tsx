export function GrowthTruthBoundary() {
  return (
    <div className="mb-8 grid gap-4 rounded-none border border-runway-line bg-paper-0 p-5 shadow-sm lg:grid-cols-[0.7fr_1.3fr]">
      <div>
      ...
      <div className="grid gap-3 md:grid-cols-3">
        <div className="border-t border-runway-line pt-3">
          <p className="text-sm font-semibold text-runway-text">Draft-only lane</p>
        ...
        <div className="border-t border-runway-line pt-3">
          <p className="text-sm font-semibold text-runway-text">Notion mirror</p>
          <p className="mt-1 text-sm leading-6 text-runway-mute">
