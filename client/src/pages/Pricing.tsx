        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="mt-3 text-sm sm:text-base text-slate-300">
              Swap in your numbers to see how a managed rollout stacks up against building and operating everything in-house.
            </p>
          </div>
            ...
            <div className="hidden md:block">
              <div className="overflow-hidden rounded-3xl border border-white/15 bg-white/[0.04] backdrop-blur-sm shadow-2xl">
                <div className="grid grid-cols-[1.2fr,1fr,1fr] gap-6 border-b border-white/10 bg-white/[0.03] px-8 py-5 text-[11px] font-semibold uppercase tracking-[0.2em] text-slate-300">
                  ...
                  <div className="text-center text-emerald-200">Do it internally (DIY)</div>
                  <div className="text-center text-cyan-200">Use Blueprint (managed)</div>
                </div>
                  ...
                  {contrastRows.map((row) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <p className="text-sm leading-relaxed text-slate-200">{row.diy}</p>
                        <p className="text-sm leading-relaxed text-slate-200">{row.blueprint}</p>
                      </div>
                    );
                  })}
                </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mt-4 space-y-3">
                      <div>
                        <div className="text-[11px] uppercase tracking-wide text-emerald-300">Do it internally (DIY)</div>
                        <p className="mt-1 text-sm leading-relaxed text-slate-200">{row.diy}</p>
                      </div>
                      <div className="border-t border-white/10 pt-3">
                        <div className="text-[11px] uppercase tracking-wide text-cyan-300">Use Blueprint (managed)</div>
                        <p className="mt-1 text-sm leading-relaxed text-slate-200">{row.blueprint}</p>
                      </div>
                    </div>
                  </div>
                );
              ...
              <div className="mt-5 grid gap-4 sm:grid-cols-2">
                {tldrHighlights.map((item) => (
                  <div key={item.label} className="rounded-xl border border-white/10 bg-white/[0.04] p-4">
                    ...
                    <div className="mt-2 text-sm font-semibold text-emerald-200">DIY: {item.diy}</div>
                    <div className="mt-1 text-sm text-cyan-200">Blueprint: {item.blueprint}</div>
                  </div>
                ))}
              </div>
            </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-300">{scenario.subtitle}</div>
                  </div>
                </div>
                <ul className="mt-4 space-y-3 text-sm leading-relaxed text-slate-200">
