      ...
      <div className="relative min-h-screen bg-white font-sans text-zinc-900 selection:bg-indigo-100 selection:text-indigo-900">
        ...
        <section className="mt-20 border-t border-zinc-200 pt-16">
          <div className="mb-10 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div className="space-y-2">
              <div className="inline-flex items-center gap-2 rounded-full border border-emerald-100 bg-emerald-50/50 px-3 py-1 text-xs font-medium uppercase tracking-wider text-emerald-600">
                <Sparkles className="h-3 w-3" />
                Customer Portal
              </div>
              <h2 className="text-2xl font-bold tracking-tight text-zinc-900 sm:text-3xl">
                Your Scenes & Evaluation Services
              </h2>
              <p className="max-w-xl text-sm text-zinc-500">
                Unlock the full potential of your purchased scenes with our evaluation and publishing services.
              </p>
            </div>
          </div>

          {/* Purchased Scenes Summary (Mock) */}
          ...
          {/* CTA: Ready to Benchmark */}
          <div className="mb-10 rounded-3xl bg-gradient-to-br from-emerald-600 via-emerald-700 to-teal-800 p-8 text-white shadow-xl">
            <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
              <div className="space-y-2">
                <h3 className="text-xl font-bold">Ready to benchmark your policies?</h3>
                <p className="max-w-lg text-sm text-emerald-100">
                  You own <span className="font-semibold text-white">5 scenes</span>. Run GPU-parallel evaluations to validate your policies before real-world deployment.
                </p>
              </div>
              <a
                href="/contact"
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-white px-6 py-3 text-sm font-bold text-emerald-700 shadow-lg transition hover:bg-emerald-50"
              >
          ...
          <h3 className="mb-6 text-lg font-bold text-zinc-900">Enterprise Evaluation Services</h3>
          <div className="grid gap-6 md:grid-cols-2">
            {/* Custom Evaluation Suites */}
            <div className="group relative overflow-hidden rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm transition-all hover:shadow-lg hover:border-indigo-200">
              <div className="absolute -right-8 -top-8 h-32 w-32 rounded-full bg-gradient-to-br from-indigo-50 to-indigo-100 opacity-50 transition-transform group-hover:scale-150" />
              <div className="relative">
                <div className="mb-4 flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-bold text-zinc-900">Custom Evaluation Suites</h4>
                    <p className="text-xs text-zinc-500">$5K – $20K per suite</p>
                  </div>
                </div>
                <p className="mb-4 text-sm text-zinc-600 leading-relaxed">
                  Tailored "test courses" designed for your specific use cases. We build custom evaluation pipelines with metrics that matter to your deployment.
                </p>
            ...
            {/* Photo-to-Evaluation Pipeline */}
            <div className="group relative overflow-hidden rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm transition-all hover:shadow-lg hover:border-violet-200">
              <div className="absolute -right-8 -top-8 h-32 w-32 rounded-full bg-gradient-to-br from-violet-50 to-violet-100 opacity-50 transition-transform group-hover:scale-150" />
              <div className="relative">
                <div className="mb-4 flex items-center gap-3">
          ...
          {/* Bottom CTA */}
          <div className="mt-10 flex flex-col items-center justify-center rounded-2xl border border-dashed border-zinc-300 bg-zinc-50 p-8 text-center">
            <p className="mb-2 text-sm font-medium text-zinc-700">
              Need help choosing the right evaluation approach?
            </p>
            <p className="mb-4 text-xs text-zinc-500">
              Our team can help you design an evaluation strategy tailored to your deployment goals.
            </p>
            <a
              href="/contact"
              className="inline-flex items-center gap-2 rounded-lg bg-zinc-900 px-5 py-2.5 text-sm font-bold text-white shadow-md transition-all hover:bg-indigo-600"
            >
              Talk to an Expert
              <ArrowRight className="h-4 w-4" />
            </a>
