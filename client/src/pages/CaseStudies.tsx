  ...
  return (
    <>
      <SEO
        ...
        description="Sample case studies showing how public-facing captures can become robot evaluation runs, policy improvement scopes, and hosted-evaluation evidence for robot teams."
