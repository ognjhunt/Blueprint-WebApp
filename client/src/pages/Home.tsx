  ...
  return (
    <>
      <SEO
        ...
        description="Blueprint helps robot teams and site operators compare policies on captured real-site task packs and request simulator-backed policy-ranking support with proof boundaries attached."
        canonical="/"
