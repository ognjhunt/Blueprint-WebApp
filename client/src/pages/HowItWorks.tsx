  ...
  return <>
    ...
    <article className="ms-how ms-container">
      ...
      <div className="ms-how-steps ms-how-preparation">
        ...
        <section><span className="ms-how-number" aria-hidden="true">02</span><div><h2>Review results, then an offer.</h2><p>Before we invite teams to evaluate, your authorized buyer agrees to Blueprint's fee if you buy a pilot from an introduced provider. Teams evaluate for free. You see anonymized results and uncertainties; each team sees its own results. If both sides want to discuss a pilot, we introduce you privately. The provider confirms its scope, price, timing, and site conditions.</p><span className="ms-how-result">One pilot offer you can accept or decline.</span></div></section>
      </div>
      <EvaluationExample />
