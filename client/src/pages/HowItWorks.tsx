  ...
  return <>
    ...
    <article className="ms-how ms-container">
      ...
      <div className="ms-how-steps ms-how-preparation">
        ...
        <section><span className="ms-how-number" aria-hidden="true">02</span><div><h2>Review a provider-backed offer.</h2><p>We check fit and use a free, bounded evaluation when it helps. You approve what a matched team can see about your site. A suitable provider confirms its configuration, included work, price, timing, and site conditions. You see the provider, evidence, uncertainties, success measures, and an itemized total that includes Blueprint's fee. A potential match without provider commitment is labeled as such.</p><span className="ms-how-result">One pilot offer you can accept or decline.</span></div></section>
      </div>
      <EvaluationExample />
