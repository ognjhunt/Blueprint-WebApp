        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-10 px-4 py-16 sm:px-6 lg:flex-row lg:items-center lg:py-20">
          <div className="space-y-6 lg:w-2/3">
            ...
            <p className="text-base leading-relaxed text-zinc-700">
              Task logic ships with every recipe: action/observation wiring, reward terms, termination + reset rules, and default multi-env counts so you get a trainable MDP alongside the geometry.
            </p>
