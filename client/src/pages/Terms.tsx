            ...
            <div className="rounded-lg border border-white/10 bg-white/5 p-8 prose prose-invert prose-lg max-w-none">
              <section id="acceptance" className="mb-8">
                ...
                <p className="text-slate-300 leading-relaxed">
                  ...
                  access or use our Services, including venue partners, content
              ...
              <section id="services" className="mb-8">
                ...
                <p className="text-slate-300 leading-relaxed mb-4">
                  ...
                  that creates custom AR experiences for physical spaces. Our
                  Services include:
                </p>
              ...
              <section id="accounts" className="mb-8">
                ...
                <p className="text-slate-300 leading-relaxed">
                  Venue partners and business users may have additional terms
                  and responsibilities as outlined in separate agreements.
                </p>
              </section>
              ...
              <section id="intellectual-property" className="mb-8">
                ...
                <p className="text-slate-300 leading-relaxed mb-4">
                  ...
                  Services, including software, algorithms, AI models,
                  trademarks, and proprietary technology. Our Services are
                ...
                <p className="text-slate-300 leading-relaxed mb-4">
                  Content generated by our AI systems based on your inputs may
                  be used by Blueprint to improve our Services. You have the
                  right to use AI-generated content created specifically for
                  your account.
                </p>
              </section>
              ...
              <section id="payment" className="mb-8">
                ...
                <p className="text-slate-300 leading-relaxed mb-4">
                  Certain features require paid subscriptions. Fees are charged
                ...
                <ul className="list-disc pl-6 text-slate-300 space-y-2 mb-4">
                  ...
                  <li>
                    You are responsible for maintaining valid payment
                    information
                  </li>
                  <li>
                ...
                <p className="text-slate-300 leading-relaxed">
                  ...
                  applicable laws. Contact us at nijel@tryblueprint.io for
                  refund requests.
                </p>
              </section>
              ...
              <section id="disclaimers" className="mb-8">
                ...
                <p className="text-slate-300 leading-relaxed">
                  ...
                  environmental conditions, and other factors beyond our
                  control.
                </p>
              </section>
              ...
              <section id="limitation" className="mb-8">
                ...
                <div className="bg-red-50 border-l-4 border-red-400 p-4 mb-4">
                  <p className="text-slate-300 leading-relaxed font-medium">
                    TO THE MAXIMUM EXTENT PERMITTED BY LAW, BLUEPRINT SHALL NOT
              ...
              <section id="termination" className="mb-8">
                ...
                <p className="text-slate-300 leading-relaxed mb-4">
                  ...
                  these Terms, non-payment, or other reasons with appropriate
                  notice.
                </p>
                ...
                <p className="text-slate-300 leading-relaxed">
                  ...
                  immediately. We may delete your account and content, though
                  some data may be retained as required by law or legitimate
                  business purposes.
                </p>
              </section>
              ...
              <section id="governing-law" className="mb-8">
                ...
                <p className="text-slate-300 leading-relaxed mb-4">
                  ...
                  Durham, North Carolina, except for claims that may be brought
              ...
              <section
                id="contact"
                className="mb-8 bg-white/5 p-6 rounded-lg border border-white/10"
              >
                <h2 className="text-2xl font-semibold text-white mb-4">
