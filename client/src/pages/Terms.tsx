...
export const termsSections: readonly Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "Robot teams see only the task card you approve. You can hide it at any time; hiding it stops new runs. Results already produced remain in our records. For a potential match, a team may authorize us to show you its name and configuration while it sees only an anonymous task summary. You choose whether to share your business identity and specified task or scene information with that team; it must accept the private opportunity before receiving access. Direct contacts and exact site details are shared only as needed to prepare a physical pilot, with the parties' approval. Approving an introduction does not obligate you to buy a pilot.",
      "Submitting a task, receiving assessment findings, and reviewing a pilot offer cost the site nothing. A site may state rough affordability and funding status; neither is a purchase order or a provider quote. If the site buys a physical pilot, it receives one itemized proposal showing the provider's scope and price, Blueprint's separate scoped coordination and measurement fee, and the total. The site approves both charges before paid work begins. The provider contracts for and performs its physical work; the provider and Blueprint may invoice their own charges separately. Blueprint's agreed fee is for its scoped service, not a guaranteed robot outcome or a hidden success charge.",
    ],
  },
  {
    ...
    items: [
      ...
      "You are responsible for the policies, endpoints and container images you submit: you must have the right to submit them, and they must not contain malware or other people's confidential data. We run them only to perform the evaluations you buy. For optional self-directed runs, sites see an alias for your team and your results, not your identity or your policy. A matched introduction may identify your team only with your permission; it does not disclose your policy.",
    ],
  },
  {
