            ...
            <div className="grid gap-4 md:grid-cols-2">
              {taskLanes.map((lane) => (
                ...
                >
                  <img
                    src={lane.image}
                    alt={`${lane.title} humanoid generated-observation review scene`}
          ...
          <div className="grid gap-6 overflow-hidden border border-black/10 bg-slate-950 p-6 text-white lg:grid-cols-[0.5fr_0.5fr] lg:p-8">
            <div className="overflow-hidden border border-white/10">
              <img
                ...
                alt="Humanoid capture-backed evaluation proof board with route, rights, thresholds, blockers, and provenance"
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="mt-4 max-w-[31rem] text-sm leading-7 text-white/70">
                ...
                before any stronger operational policy-ranking claim can be made.
              </p>
