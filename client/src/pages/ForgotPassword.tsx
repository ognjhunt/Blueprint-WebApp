        ...
        <SurfaceSection className="py-8">
          <SurfaceBrowserFrame>
            <div className="grid min-h-[38rem] xl:grid-cols-[0.48fr_0.52fr]">
              ...
              <div className="flex items-center bg-[#101312] p-8 lg:p-10">
                <div className="mx-auto grid w-full max-w-[38rem] gap-6 lg:grid-cols-[1fr_auto_1fr] lg:items-center">
                  <div className="rounded-[1.6rem] border border-white/10 bg-paper-0 p-6">
                    ...
                    {!isSubmitted ? (
                      <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                        <label className="block space-y-2">
                          <span className="block text-[11px] font-semibold uppercase tracking-[0.24em] text-white/45">Email</span>
                          <div className="relative">
                            ...
                            <input
                              ...
                              required
                              disabled={isLoading}
                              className="h-12 w-full rounded-[1rem] border border-white/10 bg-paper-0 pl-11 pr-4 text-[15px] text-runway-text outline-none transition placeholder:text-white/35 focus:border-white/30"
                            />
                          </div>
                        </label>
                        ...
                        <a href="/sign-in" className="inline-flex items-center gap-2 text-sm text-white/55 transition hover:text-runway-text">
                      ...
                      <div className="mt-6 space-y-4">
                        <div className="inline-flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-[#101312]">
                          <CheckCircle className="h-6 w-6 text-white/70" />
                        </div>
                  ...
                  <div className="rounded-[1.6rem] border border-white/10 bg-paper-0 p-6">
                    <div className="mx-auto inline-flex h-14 w-14 items-center justify-center rounded-full border border-white/10 bg-[#101312]">
                      <CheckCircle className="h-7 w-7 text-white/70" />
                    </div>
                    <p className="mt-6 font-display uppercase text-[2rem] font-semibold tracking-[0.005em]">
