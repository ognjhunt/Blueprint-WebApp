...
export function CaptureAppDock() {
  ...
  return (
    <a
      ...
      className="fixed bottom-4 right-4 z-40 inline-flex max-w-[calc(100vw-2rem)] items-center gap-3 rounded-[1.4rem] border border-slate-200/90 bg-white/95 px-4 py-3 text-left shadow-[0_22px_54px_-30px_rgba(15,23,42,0.45)] backdrop-blur-md transition hover:border-slate-300 hover:bg-white"
