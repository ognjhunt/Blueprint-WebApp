...
export function SiteGroundedLoopGraphic() {
  ...
  return (
    <div className="relative overflow-hidden rounded-[2rem] border border-slate-200 bg-[linear-gradient(145deg,rgba(255,255,255,0.96),rgba(241,245,249,0.96))] p-5 shadow-[0_28px_90px_-54px_rgba(15,23,42,0.4)] sm:p-6 lg:p-7">
      ...
      <div className="relative">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <h2 className="mt-2 max-w-xl text-[1.75rem] font-semibold leading-[1.02] tracking-tight text-slate-950 sm:text-[2rem]">
        ...
        <div className="mt-5 grid gap-4 xl:grid-cols-[minmax(0,1.1fr)_minmax(15rem,0.9fr)] xl:items-stretch">
          <motion.article
            initial={shouldReduceMotion ? undefined : { opacity: 0, y: 18 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.55 }}
            className="relative min-h-[16.5rem] overflow-hidden rounded-[1.75rem] border border-slate-200 bg-slate-950 p-5 text-white sm:p-6"
          >
            <img
            ...
            <div className="relative">
                  ...
                  <p className="mt-4 max-w-sm text-[1.85rem] font-semibold leading-[1.02]">
                    Real geometry, task lane, occlusions, and constraints.
                  </p>
                  <p className="mt-4 max-w-xs text-sm leading-7 text-slate-200">
          ...
          <motion.div
            ...
            className="relative flex min-h-[16.5rem] items-center justify-center overflow-hidden rounded-[1.75rem] border border-slate-200 bg-white/88 px-4 py-6 shadow-[0_16px_50px_-36px_rgba(15,23,42,0.45)]"
          >
            <div className="absolute inset-x-0 top-1/2 hidden h-px -translate-y-1/2 bg-[linear-gradient(90deg,rgba(15,23,42,0.04),rgba(15,23,42,0.25),rgba(15,23,42,0.04))] xl:block" />
            <div className="absolute h-3 w-3 rounded-full bg-sky-500/70 xl:left-8 xl:top-1/2 xl:-translate-y-1/2" />
            <div className="absolute h-3 w-3 rounded-full bg-emerald-500/70 xl:right-8 xl:top-1/2 xl:-translate-y-1/2" />
          ...
          {jobCards.map((card, index) => {
            ...
            return (
              <motion.article
                ...
                className="rounded-[1.5rem] border border-slate-200 bg-white/90 p-4 shadow-[0_16px_40px_-34px_rgba(15,23,42,0.45)]"
              >
        ...
        <motion.div
          ...
          className="mt-3 rounded-[1.6rem] border border-slate-200 bg-white/88 p-4"
        >
