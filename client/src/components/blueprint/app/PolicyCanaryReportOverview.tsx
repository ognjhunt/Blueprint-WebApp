...
export function PolicyCanaryReportOverview({ result }: { result: TaskEvaluationResultSiteRecord }) {
  ...
  const runtimeCoverage = runtimeCanaryCoverage(canary.episodes || []);
