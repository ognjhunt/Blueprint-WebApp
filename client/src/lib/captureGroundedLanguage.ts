export const captureGroundedPublicCopy = {
  productSummary:
    "Blueprint helps a business turn one recurring task into a provider-backed, measurable robot-pilot offer and decide what happens afterward. A site may propose a pilot price and conditions or state a target budget; neither is a purchase order or binds a provider. An authorized buyer separately agrees to Blueprint's 5% fee, capped at $5,000, before invited free evaluation; no pilot purchase means no Blueprint fee. After evaluation, a provider may accept the proposed terms, suggest changes, or decline. The site and provider agree on final price and scope. The provider or integrator handles installation and operation while the site and responsible delivery parties approve the safety plan. A Task Evaluation Run returns a bounded decision or explicit abstention; it is not physical proof.",
  seoDescription:
